package com.yc.mdemos.mydemos.dianzanview;
...
public class DianZanViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dian_zan_view);
    ...
    class ListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (view == null) {
                view = LayoutInflater.from(DianZanViewActivity.this).inflate(R.layout.list_item, null);
            }
