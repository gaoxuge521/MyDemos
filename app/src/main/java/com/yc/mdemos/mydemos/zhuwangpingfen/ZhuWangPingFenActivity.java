package com.yc.mdemos.mydemos.zhuwangpingfen;
...
public class ZhuWangPingFenActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zhu_wang_ping_fen);
        ...
        setup(spiderWebScoreView1, circularLayout1, new Score(1.0f), new Score(8.0f), new Score(5.0f));
