package com.yc.mdemos.mydemos.fangelema;
...
public class FangeLEmAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fange_lem_a);
    ...
    class Adapter extends PagerAdapter {
        public Adapter() {
            views = new ArrayList<>();
            views.add(View.inflate(FangeLEmAActivity.this, R.layout.item_img, null));
            views.get(0).findViewById(R.id.btn_buy).setOnClickListener(new View.OnClickListener() {
                @Override public void onClick(View v) {
                    Toast.makeText(FangeLEmAActivity.this, "buy", Toast.LENGTH_SHORT).show();
                }
            });
            views.add(View.inflate(FangeLEmAActivity.this, R.layout.item_img, null));
