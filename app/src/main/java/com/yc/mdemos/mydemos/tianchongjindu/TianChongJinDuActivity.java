package com.yc.mdemos.mydemos.tianchongjindu;
...
import com.yc.mdemos.mydemos.tianchongjindu.adapter.FillablePagesAdapter;

import butterknife.Bind;
import butterknife.ButterKnife;

public class TianChongJinDuActivity extends AppCompatActivity {
    @Bind(R.id.pager)
    ViewPager pager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tian_chong_jin_du);
