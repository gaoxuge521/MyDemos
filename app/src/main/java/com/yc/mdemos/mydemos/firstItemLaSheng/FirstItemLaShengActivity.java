package com.yc.mdemos.mydemos.firstItemLaSheng;
...
public class FirstItemLaShengActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_first_item_la_sheng);
