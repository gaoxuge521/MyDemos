...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        defaultTabOneButtonIcon = context.getResources().getDrawable(R.drawable.tabfirst);
        defaultTabTwoButtonIcon = context.getResources().getDrawable(R.drawable.tabhongxin);
        defaultTabThreeButtonIcon = context.getResources().getDrawable(R.drawable.tabliebiao);
        defaultTabFourButtonIcon = context.getResources().getDrawable(R.drawable.tabpingguo);
        defaultTabFiveButtonIcon = context.getResources().getDrawable(R.drawable.tabwode);
