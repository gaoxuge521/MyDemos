    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSetColor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChenJinShiActivity.this, ColorStatusBarActivity.class);
        ...
        mBtnSetTransparent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChenJinShiActivity.this, ImageStatusBarActivity.class);
        ...
        mBtnSetForImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChenJinShiActivity.this, ImageViewActivity.class);
                startActivity(intent);
            }
        });
        ...
        mBtnUseInFragment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChenJinShiActivity.this, UseInFragmentActivity.class);
                startActivity(intent);
            }
        });
        ...
        mChbTranslucent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mChbTranslucent.isChecked()) {
                    ...
                    StatusBarUtil.setTranslucentForDrawerLayout(ChenJinShiActivity.this, mDrawerLayout, mAlpha);
                    mToolbar.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                } else {
                    contentLayout.setBackgroundDrawable(null);
                    mToolbar.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                    StatusBarUtil.setColorForDrawerLayout(ChenJinShiActivity.this, mDrawerLayout,
        ...
        mSbChangeAlpha.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (mChbTranslucent.isChecked()) {
                    ...
                    StatusBarUtil.setColorForDrawerLayout(ChenJinShiActivity.this, mDrawerLayout, mStatusBarColor, mAlpha);
                }
